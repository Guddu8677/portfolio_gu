  ...
  return (
    <section className="xl:my-36 md:mx-36 p-8" id="projects">
      <motion.div
        ...
        viewport={{ once: true, amount: 0.25 }}
      >
        <p className="sectionSubText">Projects</p>
        <h2 className="sectionHeadText">Showcasing Innovation & Skill.</h2>
      </motion.div>
      ...
      <div className="w-full flex">
        <motion.p
          ...
          viewport={{ once: true, amount: 0.25 }}
        >
          Here are some of the major projects developed by <strong>Guddu Kumar Das</strong>,
          reflecting his expertise in full-stack development, modern UI/UX, and cloud deployment.
          These works include a real-time Chat App with video/audio call support, an AI-powered Legal Research Engine,
          and a dynamic Training Management System. Each project demonstrates strong architectural decisions,
          problem-solving capabilities, and a deep passion for building impactful digital solutions.
        </motion.p>
      </div>
